...
[_ADJUST] =  LAYOUT_split_3x5_3(
  ...
  KC_PWR, _______,  _______, C_DEBUG_OS, _______,           _______,  KC_BRID,  _______, KC_BRIU,  QK_BOOT,
                     _______, _______, _______,           _______, _______, _______
),
 ...
 */
 [_MOUSE] = LAYOUT_split_3x5_3(
  MS_ACL2, MS_BTN2, MS_UP, MS_BTN1, MS_BTN3,        _______, MS_ACL0, MS_ACL1, MS_ACL2, _______,
  MS_ACL0,  MS_LEFT, MS_DOWN, MS_RGHT, _______,        _______, MS_BTN1, MS_BTN3, MS_BTN2, _______,
  ...
  if (record->event.pressed) {
    switch (keycode) {
      ...
      case C_BLK:
        ...
        return false;
      case C_QDOUBLE:
        tap_code16_delay(KC_DQUO, 10);
        if (detected_host_os() != OS_LINUX) tap_code_delay(KC_SPACE, 10);
        return false;
      case C_QSINGLE:
      ...
      case C_QGRAVE:
        ...
        return false;
      case C_TILDE:
        tap_code16_delay(S(KC_GRV), 10);
        if (detected_host_os() != OS_LINUX) tap_code_delay(KC_SPACE, 10);
        return false;
      case C_HAT:
        tap_code16_delay(KC_CIRC, 10);
        if (detected_host_os() != OS_LINUX) tap_code_delay(KC_SPACE, 10);
        return false;
      case C_TERMINAL:
        tap_code16(C(KC_K));
      ...
      case C_DEBUG_OS:
        switch (detected_host_os()) {
          case OS_UNSURE: SEND_STRING("OS_UNSURE"); break;
          case OS_LINUX: SEND_STRING("OS_LINUX"); break;
          case OS_WINDOWS: SEND_STRING("OS_WINDOWS"); break;
          case OS_MACOS: SEND_STRING("OS_MACOS"); break;
          case OS_IOS: SEND_STRING("OS_IOS"); break;
          default: SEND_STRING("OS_UNKNOWN"); break;
        }
        return false;
    }
  }
